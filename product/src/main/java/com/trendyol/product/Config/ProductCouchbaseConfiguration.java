...
@Configuration
public class ProductCouchbaseConfiguration {
    private final CouchbaseProperties couchbaseProperties;

    public ProductCouchbaseConfiguration(CouchbaseProperties couchbaseProperties) {
    ...
    @Bean
    public Collection productCollection(Cluster couchbaseCluster) {
