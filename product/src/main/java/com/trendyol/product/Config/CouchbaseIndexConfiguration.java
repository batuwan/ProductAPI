...
public class CouchbaseIndexConfiguration {
    ...
    public void createIndexes() {
        ...
        indexManager.createIndex(couchbaseProperties.getBucketName(), "product_idx",
                Collections.singletonList("id"), CreateQueryIndexOptions.createQueryIndexOptions().ignoreIfExists(Boolean.TRUE));
